  ...
  useEffect(() => {
    ...
    function render(t: number) {
      ...
      if (dustHaze) {
        ...
        d1.addColorStop(0.25, "rgba(140,90,40,0.08)");
        d1.addColorStop(0.5, "rgba(160,110,50,0.12)");
        d1.addColorStop(0.75, "rgba(140,90,40,0.08)");
        d1.addColorStop(1, "rgba(0,0,0,0)");
        ctx!.fillStyle = d1;
        ctx!.fillRect(0, 0, w, h);
        const d2 = ctx!.createLinearGradient(0, h * 0.7, w, h * 0.1);
        d2.addColorStop(0, "rgba(0,0,0,0)");
        d2.addColorStop(0.4, "rgba(120,80,30,0.07)");
        d2.addColorStop(0.6, "rgba(100,70,25,0.09)");
